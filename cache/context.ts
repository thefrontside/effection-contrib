import { createContext, type Operation, type Context } from "npm:effection@4.0.0-alpha.3";
...
export const CacheContext: Context<Cache> = createContext<Cache>("cache", DEFAULT_CACHE);
